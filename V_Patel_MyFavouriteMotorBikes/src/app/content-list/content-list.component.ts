...
import { MotorBikeService } from '../services/motor-bike.service';
...
export class ContentListComponent implements OnInit {
  ...
  constructor(private MotoBikeService:MotorBikeService, private messageService: MessageService){ }
  ngOnInit(): void {
    this.MotoBikeService.getContentObs().subscribe(content => this.contentItems = content);
    this.MotoBikeService.getContentById(0).subscribe(content=> this.items = content);
  }
